...
(function () {
	...
	Canvas.Img.prototype.type = null;
	Canvas.Img.prototype.deviceId = null;
	
	Canvas.Img.prototype.portId = null;
	Canvas.Img.prototype.buildingId = null;
	Canvas.Img.prototype.buildingName = null;
	
	Canvas.Img.prototype.Id  = null;
	Canvas.Img.prototype.Ip = null;
	Canvas.Img.prototype.Person = null;
	Canvas.Img.prototype.Phone = null;
	
	Canvas.Img.prototype.floorId = null;
	Canvas.Img.prototype.floorName = null;
	Canvas.Img.prototype.comment = null;
	Canvas.Img.prototype.code = null;
	Canvas.Img.prototype.name = null;
	Canvas.Img.prototype.cabinetsId = null;
	/**
	...
	Canvas.Img.prototype._initConfig = function(oConfig) {
		...
		//alert(oConfig.type+','+oConfig.portId);
		//设备号
		this.deviceId = oConfig.deviceId;
		//端口号
		this.portId = oConfig.portId;
		//图片类型
		this.type = oConfig.type;
		
		this.buildingId = oConfig.buildingId;
		
		this.Person = oConfig.Person;
		
		this.Ip = oConfig.Ip;
		
		this.Id = oConfig.Id;
		
		this.Phone = oConfig.Phone;
	
		this.floorId = oConfig.floorId;
		
		this.floorName = oConfig.floorName;
		
		this.buildingName = oConfig.buildingName;
		
		this.comment = oConfig.comment;
		//编号
		this.code = oConfig.code;
		
		this.name = oConfig.name;
		
		this.cabinetsId = oConfig.cabinetsId;
	};
